...
# – Test the Function
# ------------------------------------------------
# Call the function with different drug URLs
...
drug_df <- Get_Drug_Details("https://www.drugs.com/price-guide/alunbrig")
